...
export default function Header({ infoIsOpen, setInfoIsOpen }) {
  ...
  return (
    <header className="fixed inset-0 z-20 flex h-min w-full items-start justify-between px-4 py-4 font-[Nimbus-Cond] mix-blend-difference">
      <NavLink to="/" onClick={() => setInfoIsOpen(false)}>
        <h1 className="font-[display] text-2xl uppercase">Clara Bunge</h1>
        {/* <img
          src="/img/shapes.svg"
          alt="Clara Bunge"
